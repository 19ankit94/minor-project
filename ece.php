...
<title>Subjects in Electronics and Communication Engineering</title>
<meta name="description" content="list of subjects in Electronics and Communication Engineering" />
...
<ul type="disc">
<?php 
$data="select * from subject where b_code='ece'";
